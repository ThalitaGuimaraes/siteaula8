    ...
    <!-- Masthead-->
        ...
        <section class="page-section" id="Portfolio">
            <div class="container">
                ...
                <form id="blogsForm" data-sb-form-api-token="API_TOKEN" method="POST" action="portfolio.cadastrar.php">
                    <div class="row align-items-center mb-5 offset-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                <!-- Imagem input-->
                                <input class="form-control" id="image" name="inputImagem" type="text" placeholder="Informe a imagem *" data-sb-validations="required" />
